...
class Canciones:
    ...
    @classmethod
    def get_all(cls): #si este método se utiliza para obtener todas las canciones de la base de datos
    ...
    @classmethod
    def agregar_cancion(cls, data): #si este método se utiliza para agregar una canción a la base de datos
    ...
    def assign_users(self): #si este método se utiliza para asignar los usuarios que han marcado una canción como favorita
    ...
    # marcado una canción como favorita
    @classmethod #si este método estático se utiliza para obtener los usuarios que han marcado una canción como favorita    
    ...
    @classmethod #si
    def get_by_id(cls, cancion_id): #si este método se utiliza para obtener una canción por su id
