...
def mostrar_usuario(id):
    ...
    # ¿ como puedo obtener el nombre de un solo usuario, en este caso el seleccionado, pero no tengo el metodo get_one?
    usuario1 = Usuario.get_one(data)
    ...
    return render_template('mostrar_usuario.html', todas_canciones = todas_canciones, usuario=usuario, usuario1=usuario1) 
